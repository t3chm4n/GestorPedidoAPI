...
public class FecharPedidoTests : TestBase
{
    ...
    public void FecharPedido_SemProdutos_DeveLancarExcecao()
    {
        ...
        // Act & Assert
        var exception = Assert.Throws<PedidoException>(() => PedidoController.FecharPedido(4));
    ...
    {
        var exception = Assert.Throws<PedidoException>(() => PedidoController.FecharPedido(3)); // Pedido já fechado
